...
import { addComment, createPost, deletePost, listPosts, listPostsByUser, toggleLike, updatePost } from "../controllers/post.controller.js";

const router = express.Router();
router.use(verifyToken);
router.get("/", asyncHandler(listPosts));
router.get("/user/:userId", validateObjectId("userId"), asyncHandler(listPostsByUser));
